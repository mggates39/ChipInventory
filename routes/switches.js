...
const { getSwitch, createSwitch, updateSwitch, getPins, createPin, updatePin, 
...
router.get('/edit/:id', async function(req, res) {
  ...
  res.render('switch/edit', {title: 'Edit Switch Definition', data: data, package_types: package_types, component_sub_types: component_sub_types});
})
