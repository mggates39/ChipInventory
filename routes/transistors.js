...
router.get('/edit/:id', async function (req, res) {
  ...
  res.render('transistor/edit', {
    title: 'Edit Transistor Definition',
    data: data,
...
router.get('/new', async function (req, res) {
  ...
  res.render('transistor/new', {
    title: 'New Transistor Definition',
    data: data,
    package_types: package_types,
    component_sub_types: component_sub_types,
    usage_list: usage_list,
...
router.post('/:id', async function (req, res) {
  ...
  const transistor = await updateTransistor(
    id,
    data.chip_number,
    data.description,
    data.pin_count,
...
router.get('/:id', async function (req, res) {
  ...
  res.render('transistor/detail', {
    title: transistor.chip_number + ' - ' + transistor.description,
    data: transistor,
    pins: fixed_pins,
