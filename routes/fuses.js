...
router.get('/edit/:id', async function (req, res) {
  ...
  res.render('fuse/edit', {
    title: 'Edit Fuse Definition',
    data: data,
...
router.get('/:id', async function (req, res) {
  ...
  res.render('fuse/detail', {
    title: fuse.chip_number + ' - ' + fuse.description,
    data: fuse,
    pins: fixed_pins,
