...
router.get('/new', async function (req, res) {
  ...
  res.render('capacitor_network/new', {
    title: 'New Capacitor Network Definition',
    data: data,
...
router.get('/:id', async function (req, res) {
  ...
  const data = await getCapacitorNetwork(id);
  ...
  res.render('capacitor_network/detail', {
...
router.get('/edit/:id', async function (req, res) {
  ...
  res.render('capacitor_network/edit', {
    title: 'Edit Capacitor Network Definition',
    data: data,
    package_types: package_types,
    component_sub_types: component_sub_types,
    unit_list: unit_list,
...
router.post('/new', async function (req, res) {
  ...
  if (descr[req.body.pin_count - 1]) {
    ...
    var capacitor_id = capacitor.component_id;
...
router.post('/:id', async function (req, res) {
  ...
  const capacitor = await updateCapacitorNetwork(
    id,
    data.chip_number,
    data.package_type_id,
    data.component_sub_type_id,
  ...
  res.redirect('/capacitor_networks/' + id);
});
