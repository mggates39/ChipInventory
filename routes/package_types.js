...
router.get('/:id', async function (req, res) {
  ...
  res.render('package_type/detail', {
    title: 'Package Type',
    package_type: data,
    component_types: comps,
  });
...
router.post('/new', async function (req, res) {
  const package_type = await createPackageType(
    req.body.name,
    req.body.description,
    req.body.mounting_type_id,
    req.body.component_type_selection,
  );
