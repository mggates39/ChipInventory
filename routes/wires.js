...
router.get('/edit/:id', async function (req, res) {
  ...
  res.render('wire/edit', {
    title: 'Edit Wire Definition',
    data: data,
...
router.get('/:id', async function (req, res) {
  ...
  res.render('wire/detail', {
    title: wire.chip_number + ' - ' + wire.description,
    data: wire,
    pins: fixed_pins,
