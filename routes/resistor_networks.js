...
router.get('/new', async function (req, res) {
  ...
  res.render('resistor_network/new', {
    title: 'New Resistor Network Definition',
    data: data,
...
router.get('/:id', async function (req, res) {
  ...
  res.render('resistor_network/detail', {
...
router.get('/edit/:id', async function (req, res) {
  ...
  res.render('resistor_network/edit', {
    title: 'Edit Resistor Network Definition',
    data: data,
    package_types: package_types,
    component_sub_types: component_sub_types,
    unit_list: unit_list,
...
router.post('/:id', async function (req, res) {
  ...
  const resistor = await updateResistorNetwork(
    id,
    data.chip_number,
    data.package_type_id,
    data.component_sub_type_id,
