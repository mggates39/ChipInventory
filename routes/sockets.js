...
router.get('/edit/:id', async function (req, res) {
  ...
  res.render('socket/edit', {
    title: 'Edit Socket Definition',
    data: data,
...
router.get('/new', async function (req, res) {
  ...
  res.render('socket/new', {
    title: 'New Socket Definition',
    data: data,
    package_types: package_types,
    component_sub_types: component_sub_types,
  });
...
router.post('/new', async function (req, res) {
  ...
  if (descr[req.body.pin_count - 1]) {
    ...
    var socket_id = socket.component_id;
...
router.post('/:id', async function (req, res) {
  ...
  const socket = await updateSocket(
    id,
    data.chip_number,
    data.pin_count,
    data.package_type_id,
...
router.get('/:id', async function (req, res) {
  ...
  const component_type_id = socket.component_type_id;
  ...
  res.render('socket/detail', {
    title: socket.chip_number + ' - ' + socket.description,
    data: socket,
    pins: fixed_pins,
