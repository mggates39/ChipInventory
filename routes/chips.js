...
router.get('/edit/:id', async function (req, res) {
  ...
  res.render('chip/edit', {
    title: 'Edit Integrated Circuit Definition',
    data: data,
...
router.get('/new', async function (req, res) {
  ...
  res.render('chip/new', {
    title: 'New Integrated Circuit Definition',
    data: data,
    package_types: package_types,
    component_sub_types: component_sub_types,
  });
...
router.get('/:id', async function (req, res) {
  ...
  res.render('chip/detail', {
    title: chip.chip_number + ' - ' + chip.description,
    data: chip,
    pins: fixed_pins,
