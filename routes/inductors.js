...
router.get('/edit/:id', async function (req, res) {
  ...
  res.render('inductor/edit', {
    title: 'Edit Inductor Definition',
    data: data,
...
router.get('/new', async function (req, res) {
  ...
  res.render('inductor/new', {
    title: 'New Inductor Definition',
    data: data,
    package_types: package_types,
    component_sub_types: component_sub_types,
  });
...
router.post('/new', async function (req, res) {
  ...
  if (descr[req.body.pin_count - 1]) {
    const inductor = await createInductor(
      data.chip_number,
      data.pin_count,
...
router.post('/:id', async function (req, res) {
  ...
  const inductor = await updateInductor(
    id,
    data.chip_number,
    data.pin_count,
    data.package_type_id,
...
router.get('/:id', async function (req, res) {
  ...
  res.render('inductor/detail', {
    title: inductor.chip_number + ' - ' + inductor.description,
    data: inductor,
    pins: fixed_pins,
