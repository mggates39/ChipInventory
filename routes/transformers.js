...
router.get('/edit/:id', async function (req, res) {
  ...
  res.render('transformer/edit', {
    title: 'Edit Transformer Definition',
    data: data,
...
router.get('/new', async function (req, res) {
  ...
  res.render('transformer/new', {
    title: 'New Transformer Definition',
    data: data,
    package_types: package_types,
    component_sub_types: component_sub_types,
  });
...
router.post('/:id', async function (req, res) {
  ...
  const transformer = await updateTransformer(
    id,
    data.chip_number,
    data.pin_count,
    data.package_type_id,
...
router.get('/:id', async function (req, res) {
  ...
  if (transformer.package == 'SIP') {
    ...
    plcc_left_pins.forEach(function (pin) {
      ...
      layout_pins.push({
        ...
        bull: bull,
        right_pin: plcc_right_pins[i].pin_number,
        left_sym: parse_symbol(pin.pin_symbol),
        right_sym: parse_symbol(plcc_right_pins[i].pin_symbol),
      });
      i++;
    });
    ...
    quad_left_pins.forEach(function (pin) {
      ...
      layout_pins.push({
        left_pin: pin.pin_number,
        bull: bull,
        right_pin: quad_right_pins[i].pin_number,
        left_sym: parse_symbol(pin.pin_symbol),
        right_sym: parse_symbol(quad_right_pins[i].pin_symbol),
      });
      i++;
    });
  ...
  res.render('transformer/detail', {
    title: transformer.chip_number + ' - ' + transformer.description,
    data: transformer,
    pins: fixed_pins,
