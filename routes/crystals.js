...
router.get('/new', async function (req, res) {
  ...
  res.render('crystal/new', {
    title: 'New Crystal Definition',
    data: data,
...
router.get('/edit/:id', async function (req, res) {
  ...
  res.render('crystal/edit', {
    title: 'Edit Crystal Definition',
    data: data,
    package_types: package_types,
    component_sub_types: component_sub_types,
    unit_list: units,
...
router.post('/:id', async function (req, res) {
  ...
  const crystal = await updateCrystal(
    id,
    data.chip_number,
    data.frequency,
    data.unit_id,
