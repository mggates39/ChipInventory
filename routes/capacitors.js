...
router.get('/new', async function (req, res) {
  ...
  res.render('capacitor/new', {
    title: 'New Capacitor Definition',
    data: data,
...
router.get('/edit/:id', async function (req, res) {
  ...
  res.render('capacitor/edit', {
    title: 'Edit Capacitor Definition',
    data: data,
    package_types: package_types,
    component_sub_types: component_sub_types,
    unit_list: unit_list,
...
router.post('/:id', async function (req, res) {
  ...
  const capacitor = await updateCapacitor(
    id,
    data.chip_number,
    data.package_type_id,
    data.component_sub_type_id,
