...
router.get('/edit/:id', async function (req, res) {
  ...
  res.render('connector_jack/edit', {
    title: 'Edit Jack Definition',
    data: data,
...
router.get('/new', async function (req, res) {
  ...
  res.render('connector_jack/new', {
    title: 'New Jack Definition',
    data: data,
    package_types: package_types,
    component_sub_types: component_sub_types,
  });
...
router.post('/new', async function (req, res) {
  ...
  if (descr[req.body.pin_count - 1]) {
    ...
    var connector_id = connector.component_id;
...
router.get('/:id', async function (req, res) {
  ...
  res.render('connector_jack/detail', {
    title: connector.chip_number + ' - ' + connector.description,
    data: connector,
    pins: fixed_pins,
